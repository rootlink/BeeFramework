...
class Persona{
    //private = no puede ser utilizada en ningun otro lado más que dentro de la clase dueña.
    ...
    //Metodo para obtener el nombre del array
    ...
    //Metodo para obtener un apellido del array
